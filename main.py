...
err = run_all_regressions(x, y, regs="regressions/reg_lists/five_best.py", verbose=True, show=False, x_test=0.1, final_verbose=True, selection_algo=sel, seed=0, split_func=split_func_for_reg(year))
